...
7. Introduce per-change gates with a documented adoption baseline.
...
new/changed runtime files, and migrate high-risk modules first. A baseline is temporary debt accounting, not a gate
bypass.
